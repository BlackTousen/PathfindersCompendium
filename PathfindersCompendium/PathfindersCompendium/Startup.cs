...
namespace PathfindersCompendium
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ISpellSheetRepository, SpellSheetRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PathfindersCompendium", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "PathfindersCompendium v1"));
            }
